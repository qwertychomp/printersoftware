import machine
#"import" stepper by copying and pasting its code 
import math
...
# source for revSteps: some random article probably wrrittn by somene who doesnt speak english as there first language
revSteps = 2048
s1 = Stepper(0, 1, steps_per_rev=revSteps,speed_sps=100)
s2 = Stepper(6, 5, steps_per_rev=revSteps,speed_sps=100)
#set the speed to something low or something idk
s1.speed(20)
s2.speed(20)
def test():
    s1.free_run(-1)
